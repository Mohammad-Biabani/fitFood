    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('C_gender', models.CharField(max_length=255)),
                ...
                ('C_zipcode', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CAdminID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.catering_admin')),
            ],
        ),
        migrations.CreateModel(
            name='Pack',
            fields=[
                ...
                ('DAdminID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.delivery_admin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CAdminID', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='api.catering_admin')),
                ('customerID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('foodID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.food')),
                ('packID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.pack')),
            ],
        ),
    ]
